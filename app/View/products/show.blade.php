...
<section class="bg-gray-50 py-16">
    <div class="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        <div>
            <img src="{{ $product['img'] }}" alt="{{ $product['name'] }}" class="rounded-2xl shadow-lg w-full object-cover">
        </div>
        <div>
            ...
            <div class="flex gap-4">
                ...
                <a href="/products" class="bg-gray-200 text-gray-800 py-3 px-6 rounded-lg font-semibold hover:bg-gray-300 transition">
                    Kembali
                </a>
            </div>
        </div>
